...
from src.Tools.json_handler import update_json, read_json, update_json_2
...
def equip(obj, close, item_type, item_info, image_path,
    ...
    # If a ship item is clicked, health, velocity and sprite image are updated.
        if item_type == "ships":
            ...
            update_json_2("players", {"Movement_Speed" : new_movement_speed})
            update_json_2("players", {"Sprite" : new_player_sprite_path})
            recreate_players()
        ...
        if item_type == "upgrades":
            ...
            update_json_2("weapons", {f"{weapon_name}.Damage" : (damage + damage_increase)})
